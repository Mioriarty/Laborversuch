        ...
        public override void BuildContextualMenu(ContextualMenuPopulateEvent evt) {
            ...
            Vector2 nodePosition = this.ChangeCoordinatesTo(contentViewContainer, evt.localMousePosition);
            {
                ...
                foreach (var type in types) {
                    evt.menu.AppendAction($"Action Nodes/{type.Name}", (a) => CreateNode(type, nodePosition));
                }
            }

            {
                ...
                foreach (var type in types) {
                    evt.menu.AppendAction($"Composite Nodes/{type.Name}", (a) => CreateNode(type, nodePosition));
                }
            }

            {
                ...
                foreach (var type in types) {
                    evt.menu.AppendAction($"Decorator Nodes/{type.Name}", (a) => CreateNode(type, nodePosition));
                }
            }
        }
